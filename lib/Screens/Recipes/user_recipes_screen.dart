  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: ()async{
            _UserRecipesBloc.add(UserRecipesFetchEvent());
          },
          child: Container(
            margin: EdgeInsets.fromLTRB(0, 10, 0, 0),
            child: ListView(
              children: [BlocConsumer<UserRecipesBloc, UserRecipeState>(
                ...
                if (state is UserRecipeStateSuccess) {
                  showAlertDialog(BuildContext context, int id) {
                    ...
                    Widget continueButton = TextButton(
                      child: Text("Delete"),
                      onPressed: () {
                        _UserRecipesBloc.add(UserRecipesDeleteEvent(
                            state.recipes[id].recipeId));
                        Navigator.of(context).pop();
                      },
                     ...
                     ListView.builder(
                      ...
                      itemBuilder: (context, index) => Slidable(
                        ...
                        secondaryActions: <Widget>[
                          ...
                          IconSlideAction(
                            caption: state.recipes[index].status == 1
                                ? "public"
                                : "private",
                            color: kPrimaryButtonColor2,
                            icon: state.recipes[index].status == 1
                                ? FontAwesomeIcons.eye
                                : FontAwesomeIcons.eyeSlash,
                            onTap: () {
                              _UserRecipesBloc.add(SetPrivateEvent(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            state.recipes[index].status == 1
                                                ? Text(
                                                    "Pending",
                                                    style: TextStyle(
                                                        color: kPrimaryTextColor5),
                                                  )
                                                : state.recipes[index]
                                                            .status ==
                                                        2
                                            ...
                                            state.recipes[index].isFlagged == true ? Text(" - **Flagged**",style: TextStyle(
                                                color: Colors
                                                .redAccent),) : SizedBox()
                                          ],
                                        ),
